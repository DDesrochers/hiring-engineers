...
![Screencap of Tags](http://52.233.42.140/1.Tags.JPG)
    
***Install a database on your machine (MongoDB, MySQL, or PostgreSQL) and then install the respective Datadog integration for that database.
  
![Screencap of MySQL](http://52.233.42.140/2.MySQL.JPG)
...
***Bonus Question Can you change the collection interval without modifying the Python check file you created?
   ...
   > ANSWER: 
   Yes by modifying the collection interval in the YAML file (my_metric.yaml)
        instances:
        - min_collection_interval: 45
...
![Screencap of Timeframe](http://52.233.42.140/9.Timeframe.JPG) 
 
*Take a snapshot of this graph and use the @ notation to send it to yourself.

![Screencap of Notation](http://52.233.42.140/10.Notation.JPG)
![Screencap of Notation Email](http://52.233.42.140/10.Notation-Email.JPG)
...
![Screencap of Monitor](http://52.233.42.140/11.Monitor.png)
...
![Screencap of Email Notification](http://52.233.42.140/11.EmailNotification.JPG)
...
![Screencap of Downtime](http://52.233.42.140/12.Downtime.JPG)
![Screencap of Downtime Email](http://52.233.42.140/12.DowntimeEmail.JPG)
...
[link to Dashboard!](https://app.datadoghq.com/dashboard/rf2-afu-sfj/daves-dashboard)

![Screencap of Dashboard](http://52.233.42.140/15.Dashboard.JPG)
...
# FINAL QUESTION:
   ...
   > Realtime metrics on energy usage overlaid with time of day rates. This would be a compelling way to provide a visual on optimal time to use energy and appreciate how much energy is used locally.
